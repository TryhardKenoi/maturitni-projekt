...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="card card-outline card-secondary">
      ...
      <div class="card-body">
        <p class="login-box-msg"><?php echo lang('Auth.login_heading');?></p>
